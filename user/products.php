	...
	<div class="cartcontainer">
      ...
      <div class="container recipe-menu">
        ...
        <div class="section-title">
          <h2>Best<span> Recommended Products for <?php echo $_GET['pfor'];?></span></h2>
         </div>
...
<?php 
 if(isset($_GET['pfor']))
                          {
							  $pfor=$_GET['pfor'];
						     "SELECT * FROM ip_product where pcategory='$pfor'";
                          $query = "SELECT * FROM ip_product where pcategory='$pfor'";
